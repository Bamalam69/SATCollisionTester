...
class MyTestCase(unittest.TestCase):
    ...
    def test_sat(self):
        ...
        self.assertEqual(IntersectTester(control_shape2, control_shape1).test_major().intersecting, True)
        self.assertEqual(IntersectTester(control_shape2, control_shape3).test_major().intersecting, False)
    ...
    def test_major(self):
        control_shape1 = [(0, 0), (0, 10), (10, 10), (10, 0), (0, 0)]
        control_shape2 = [Vector2(tuple_vector[0], tuple_vector[1]) + Vector2(5, 5) for tuple_vector in control_shape1]
        self.assertEqual(IntersectTester(control_shape1, control_shape2).test_major().intersecting, True)
